  ...
  <header id="header" class="fixed-top "> 
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="cus_home.php">Home</a></li>
          
          <li><a class="nav-link scrollto " href="pro.php">product</a></li>
          <li><a class="nav-link scrollto " href="service.php">service</a></li>
          
          <li><a class="nav-link scrollto " href="cus_message_seen.php">message</a></li>
           <!--  <ul>
              <li><a href="#">Add Product</a></li>
              <li class="dropdown"><a href="#"><span>View product</span> <i class="bi bi-chevron-right"></i></a>
 -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>Talent hub</h3>
            <p class="font-italic">
             To make a web site which was greatly helpful for college students and public. Here, it provides a space for students to post there creative works and their talents. It also provide services for public by acquiring several favours from college students. Through this app students can sell their products and can earn money.
            </p>
            <ul>
         ...
         <!--  <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Student council</a></h4>
