      ...
      <div class="container" data-aos="fade-up">
        ...
        ?>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
           ...
           <a href="ser.php?pid=<?php echo $data['ser_id'];?>" button class="btn btn-primary" id="submit" type="sub" name="sub"><i class="fa fa-fw fa-lg fa-check-circle"></i>Request</button></i></a></i>
