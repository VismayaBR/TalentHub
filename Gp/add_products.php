...
$streg_query=mysqli_query($conn,"SELECT * FROM student_reg_tb WHERE login_id='$id'");
$row1=mysqli_fetch_assoc($streg_query);
$c_reg_id=$row1['reg_id'];

$pic="";
//var_dump($c_reg_id);exit();
...
if(isset($_POST['sub']))
{
 ...
 $select=mysqli_query($conn,"INSERT INTO `product_tb`(`cat_id`,`name`,`image`,`reg_id`) VALUES('$cat_id','$name','$image','$c_reg_id')");
