...
if(isset($_POST['sub']))
{
  ...
  mysqli_query($conn,"INSERT INTO order_product_tb(reg_id,name,message,cust_reg_id,product_id) VALUES ('$reg_id','$name','$message','$c_reg_id','$product')");
...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto " href="cus_home.php">Home</a></li>
      ...
      <a href="../docs/logout.php" class="get-started-btn scrollto">logout</a>
