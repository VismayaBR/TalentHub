...
if(isset($_POST['sub']))
{
 ...
 $address=$_POST['address'];
  ...
  mysqli_query($conn,"INSERT INTO login_tb (username,password,type) VALUES ('$user','$passw','customer')");
  $last_login_id=mysqli_insert_id($conn);
 $select=mysqli_query($conn,"INSERT INTO `customer_reg_tb`(`login_id`,`name`,`gender`,`email`,`mobile`,`address`) VALUES('$last_login_id','$name','$gender','$email','$mobile','$address')");
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Customer Registration<span></span></h1>
          <h2></h2>
        </div>
      </div>
...
<div class="col-md-6 form-group mt-3">
                <input type="text" class="form-control" name="mobile" id="mobile" placeholder="mobile number" required=""required="required"pattern="[0-9].{9}" >
              </div>
<div class="col-md-6 form-group mt-3">
    ...
    <!-- <div class="col-md-6 form-group mt-3">
              ...
              <div class="col-md-6  form-group mt-3">
                <textarea class="form-control" name="service details" id="service details"rows="5" placeholder="service details" required></textarea>
              </div> -->
            <br>
<!-- 
              <div class="my-3">
              ...
              <button class="btn btn-primary" id="submit" type="sub" name="sub"><i class="fa fa-fw fa-lg fa-check-circle"></i>Register</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
