      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i>This put forward a new platforms to students to share their ideas and their abilities. The platforms offers the students can prove their own abilities. one of the biggest benefits of using talent pool insight you can’t find elsewhere. Talent hub allows you to tap into data from the largest talent community. 
</li>
