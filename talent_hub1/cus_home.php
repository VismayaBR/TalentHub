    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="send_rply.php">message</a></li>
           <!--  <ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>Talent hub</h3>
            <p class="font-italic">
             To make a web site app which was greatly helpful for college students and public. Here, it provides a space for students to post there creative works and their talents. It also provide services for public by acquiring several favours from college students. Through this app students can sell their products and can earn money.
            </p>
            <ul>
