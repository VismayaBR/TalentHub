...
if(isset($_POST['sub']))
{
 ...
 $department=$_POST['department'];
  ...
  mysqli_query($conn,"INSERT INTO service(name,department) VALUES ('$name','$department')");
  header("location:Service_dept.php");
              ...
              <div class="col-lg-6">
                <form method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="name" id="name" type="text" aria-describedby="" placeholder="enter service">
                  </div>
                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="department" name="department" required="" >
                                            ...
                                            <?php
                                            $var=mysqli_query($conn,"SELECT * FROM dept_tb");
